...
class DB(Enum):
    ...
    def init_cls(self) -> Type[VectorDB]:
        ...
        if self == DB.PgVector2:
            from .pgvector2.pgvector2 import PgVector2
            return PgVector2
        ...
        if self == DB.SingleStore:
            from .singlestore.singlestore import SingleStore
            return SingleStore
    ...
    def config_cls(self) -> Type[DBConfig]:
        ...
        if self == DB.SingleStore:
            from .singlestore.config import SingleStoreConfig
    ...
    def case_config_cls(self, index_type: IndexType | None = None) -> Type[DBCaseConfig]:
        ...
        if self == DB.SingleStore:
            from .singlestore.config import _singlestore_case_config
